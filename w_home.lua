...
local btnstyle
if(re_st==1)then styl="#butoff {background: green}"
else styl="#buton {background: green}"
...
<input type=text size=15 name=host value=192.168.1.2 placeholder=IP>:<input type=number name=port value=80>
